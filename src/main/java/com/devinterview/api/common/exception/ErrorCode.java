...
public enum ErrorCode {
    ...
    EMAIL_ALREADY_EXISTS(HttpStatus.CONFLICT, "AUTH_008", "이미 사용 중인 이메일입니다."),
    PASSWORD_MISMATCH(HttpStatus.BAD_REQUEST, "AUTH_009", "비밀번호가 일치하지 않습니다."),
    ACCOUNT_WITHDRAWN(HttpStatus.FORBIDDEN, "AUTH_010", "탈퇴한 계정입니다."),
    ...
    ANSWER_TIME_EXCEEDED(HttpStatus.BAD_REQUEST, "INTERVIEW_011", "답변 제한 시간을 초과했습니다."),
    QUESTION_ORDER_INVALID(HttpStatus.BAD_REQUEST, "INTERVIEW_012", "질문 순서가 올바르지 않습니다."),
    ANSWER_ALREADY_SUBMITTED(HttpStatus.CONFLICT, "INTERVIEW_013", "이미 제출된 질문입니다."),
